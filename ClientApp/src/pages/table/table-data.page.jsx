...
const TableDataPage = ({ schema, match, location, dispatch, loggedIn }) => {
    ...
    const [isCreateTableRecordModalVisible, setCreateTableRecordModalVisible] =
    ...
    return (
        <React.Fragment>
            {loadingTableColums && <Loading></Loading>}
