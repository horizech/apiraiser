...
const AddTableColumn = ({
    ...
    const foreignSchemaOptions = Object.keys(Schemas).map((x) => {
        ...
        let result = {
            ...
            ForeignSchema:
                data.IsForeignKey && data.ForeignSchema
                    ...
                    : null,
            ForeignTable:
                data.IsForeignKey && data.ForeignTable
                    ? data.ForeignTable.value
                    : null,
            ForeignName:
                data.IsForeignKey && data.ForeignName
                    ? data.ForeignName.value
                    : null,
